...
path = '..\\..\\Files_generated\\Classifiers_results\\Classic\\Neural_network\\'
...
model_results = fit_model(X_data, y, batch_size_value, test_size_val, repetitions_val, number_of_features_val)
