...
def fit_model(X_train, X_test, y_train, y_test, number_of_features, high_threshold, low_threshold):
    ...
    predicted_class = model.predict_classes(X_test, verbose=1)[0][0]
    ...
    return conf_matrix, predicted_class, y_pred, bet_safe, bet_safe_conf_matrix
...
path = '..\\..\\Files_generated\\Classifiers_results\\Game_by_game_threshold_voting\\Neural_network\\'
...
for idx, g in enumerate(games):
    ...
    for i in range(1, predictions_per_game+1):
        single_game_result = fit_model(X_train_val, X_test_val, y_train_val, y_test_val, number_of_features_val,
