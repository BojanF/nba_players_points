...
path = '..\\..\\Files_generated\\Classifiers_results\\Game_by_game\\Neural_network_2\\'
...
for g in games:
    ...
    result = fit_model(X_train_val, X_test_val, y_train_val, y_test_val_categorical, number_of_features_val)
