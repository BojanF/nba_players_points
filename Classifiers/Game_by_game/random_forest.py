...
def fit_model(X_train, X_test, y_train, y_test):
    ...
    return conf_matrix, predicted_class[0]
...
path = '..\\..\\Files_generated\\Classifiers_results\\Game_by_game\\Random_forest\\'
...
for g in games:
    ...
    result = fit_model(X_train_val, X_test_val, y_train_val, y_test_val)
    ...
    file.write('Predicted class: ' + str(int(result[1])))
